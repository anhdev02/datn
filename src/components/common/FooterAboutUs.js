          ...
          <div className="footer__pad row">
              ...
              <div className="footer-nav__pad">
                <ul className="d1-list">
                  <li className="d1 d1--about has-sublist">
                    <a href="/eng/about" className="d1__item linkline"><span className="linkline__text">
                  ...
                  <li className="d1 d1--product has-sublist">
                    <a href="/eng/product" className="d1__item linkline"><span className="linkline__text">
                  ...
                  <li className="d1 d1--innovation has-sublist">
                    <a href="/eng/innovation" className="d1__item linkline"><span className="linkline__text">
                  ...
                  <li className="d1 d1--story has-sublist">
                    <a href="/eng/story" className="d1__item linkline"><span className="linkline__text">
                  ...
                  <li className="d1 d1--esg has-sublist">
                    <a href="/eng/esg" className="d1__item linkline"><span className="linkline__text">
                  ...
                  <li className="d1 d1--career has-sublist">
                    <a href="/eng/career/index" className="d1__item linkline"><span className="linkline__text">
            ...
            <div className="footer-info col-sm-6 col-lg-4">
              ...
              <ul className="footer-links footer-links--bottom">
                <li>
                  <a href="/eng/util/global-network" className="footer-link linkline">
                    <span className="linkline__text">Global Network</span>
                  </a>
                </li>
                <li>
                  <a href="/eng/util/global-network#contact" className="footer-link linkline">
                    <span className="linkline__text">Inquiry</span>
                  </a>
                </li>
                <li>
                  <a href="/eng/misc/coockies-policy" className="footer-link linkline">
                ...
                <li>
                  <a href="/eng/util/ethics/rule" className="footer-link linkline">
              ...
              <ul className="footer-toggle">
                <li className="footer-toggle__item footer-address">
                  <span className="footer-toggle__btn footer-copyright">© 2021 LocknLock Co. All Rights Reserved.</span>
