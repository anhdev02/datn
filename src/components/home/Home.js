              ...
              <div className="swiper-container swiper-container1">
                <div className="swiper-wrapper">
                  <div
                    ...
                    style={{
                      backgroundImage:
                        'url("assets/imgs/2023FEB04-12_PC_Slidebanner_2543.jpg")',
                    }}
                  >
                  ...
                  <div
                    ...
                    style={{
                      backgroundImage:
                        'url("assets/imgs/Slidebanner_AUG_19_03_ENR226WHT.jpg")',
                    }}
                  >
                    <a href="#" className="slide-more">
                      {" "}
                  ...
                  <div
                    ...
                    style={{
                      backgroundImage:
                        'url("assets/imgs/LHC8052S01%20Pump%20Vacuum%20Lunch%20Box.jpg")',
                    }}
                  >
                    <a href="#" className="slide-more">
                      {" "}
                  ...
                  <div
                    ...
                    style={{
                      backgroundImage:
                        'url("assets/imgs/EJF996BLK_Visible%20Airfryer%20Cube.jpg")',
                    }}
                  >
                    <a href="#" className="slide-more">
                      {" "}
                  ...
                  <div
                    ...
                    style={{
                      backgroundImage:
                        'url("assets/imgs/20220923_Slidebanner_toothbrush.jpg")',
                    }}
                  >
                    <a href="#" className="slide-more">
                      {" "}
            ...
            <div className="root_width">
              ...
              <div className="wrap-box">
                <div className="in-box">
                  <a href="#">
                    <span>
                      <img src="assets/imgs/banner-m1.png" alt="" />
                    </span>
              ...
              <div className="in-article root_width Product-list-slide">
                <div className="xans-element- xans-product xans-product-listmain-1 xans-product-listmain xans-product-1 mProduct swiper-container swiper-container2 swiper-initialized swiper-horizontal swiper-pointer-events">
                  <ul
                    ...
                    id="swiper-wrapper-03385bdc7666f4107"
                    style={{
                          ...
                          <h4 className="name">
                            <a href="#" className>
                              <span
                                style={{ fontSize: "12px", color: "#555555" }}
                              >
                                LLG510S3 - Hộp đựng thức ăn cho bé Lock&amp;Lock
                                260ml*3 hộp - Nắp màu cam, silicone màu cam
                              </span>
                            </a>
                          </h4>
                          <ul className="xans-element- xans-product xans-product-listitem-1 xans-product-listitem xans-product-1 spec">
                          ...
                          <h4 className="name">
                            <a href="#" className>
                              ...
                              >
                                ...
                                Detachable 18cm - 22cm - 26cm tay cầm có thể
                                tháo rời màu xanh mint - SDE1181IHS01
                              </span>
                            </a>
                          </h4>
                          <ul className="xans-element- xans-product xans-product-listitem-1 xans-product-listitem xans-product-1 spec">
                          ...
                          <h4 className="name">
                            <a href="#" className>
                              ...
                              >
                                ...
                                LocknLock Steam Air Fryer Oven 12.5L, 220-240V,
                                50/60Hz, 985-1635W - EJF693GRY
                              </span>
                            </a>
                          </h4>
                          <ul className="xans-element- xans-product xans-product-listitem-1 xans-product-listitem xans-product-1 spec">
                          ...
                          <h4 className="name">
                            <a href="#" className>
                              <span
                                style={{ fontSize: "12px", color: "#555555" }}
                              >
                                Máy Nướng Bánh Mì Lock&amp; Lock EJB221BLU (730
                                - 870 W)
                              </span>
                            </a>
                          </h4>
                          ...
                          <h4 className="name">
                            <a href="#" className>
                              ...
                              >
                                ...
                                Cordless Oral Irrigator, 200ml - Màu xanh da
                                trời
                              </span>
                            </a>
                          </h4>
                          ...
                          <h4 className="name">
                            <a href="#" className>
                              <span
                                style={{ fontSize: "12px", color: "#555555" }}
                              >
                                EJM501DGRY - Máy đánh trứng Lock&amp;Lock Hand
                                Mixer 220-240V, 50/60Hz, 250-300W - Màu xám đậm
                              </span>
                            </a>
                          </h4>
                          <ul className="xans-element- xans-product xans-product-listitem-1 xans-product-listitem xans-product-1 spec">
                ...
                <div className="root_width">
                  <div className="productList mProduct typeThumb">
                    <div className="wrap-banner">
                      <a href="#">
                        <img src="assets/imgs/ricecooker%20pc.jpg" />
                      </a>
                    </div>
                    <div className="in-article root_width Product-list-slide">
                      <div className="xans-element- xans-product xans-product-listmain-2 xans-product-listmain xans-product-2 mProduct swiper-container swiper-container3 swiper-initialized swiper-horizontal swiper-pointer-events">
                        <ul
                          className="swiper-wrapper"
                          id="swiper-wrapper-361fb3e5be7d6dfa"
                          style={{
                            transitionDuration: "0ms",
                              ...
                              <div className="thumbnail">
                                <div className="prdImg">
                                  <div className="wrap-thumbnail">
                                    <a className="BG-thumbnail" href="#">
                                      <img
                                        src="assets/imgs/eb15f23c194ca0e69fa7d3b669d8ef80.jpg"
                                        id="eListPrdImage689_3"
                                        alt="Bộ dao kéo nhà bếp bằng thép không gỉ Lock&amp;Lock CKK303.304.305 màu đen"
                                      />
                                    </a>
                                  </div>
                                  <div className="salebox displaynone">
                              ...
                              <div className="description">
                                ...
                                <h4 className="name">
                                  <a href="#" className>
                                    ...
                                    >
                                      Bộ dao kéo nhà bếp bằng thép không gỉ
                                      Lock&amp;Lock CKK303.304.305 màu đen
                                    </span>
                                  </a>
                                </h4>
                              ...
                              <div className="description">
                                ...
                                <h4 className="name">
                                  <a href="#" className>
                                    ...
                                    >
                                      Bình giữ nhiệt Lock&amp;Lock Easy Outdoor
                                      Vacuum Bottle 1.2L và 1.8L có nắp cốc và
                                      dây đeo vai LHC1484,LHC1485
                                    </span>
                                  </a>
                                </h4>
                                <ul className="xans-element- xans-product xans-product-listitem-2 xans-product-listitem xans-product-2 spec">
                              ...
                              <div className="description">
                                ...
                                <h4 className="name">
                                  <a href="#" className>
                                    ...
                                    >
                                      Bình giữ nhiệt Lock&amp;Lock Jumbo Tumbler
                                      900 ml - LHC4300
                                    </span>
                                  </a>
                                </h4>
                              ...
                              <div className="thumbnail">
                                <div className="prdImg">
                                  <div className="wrap-thumbnail">
                                    <a className="BG-thumbnail" href="#">
                                      <img
                                        src="assets/imgs/f21f78e0b0bcac439f1da5862c85aa3b.jpg"
                                        id="eListPrdImage682_3"
                                        alt="Ly nhựa 2 lớp có ống hút Lock&amp;Lock Bucket cold cup 580ml - HAP520"
                                      />
                                    </a>
                                  </div>
                                  <div className="salebox displaynone">
                              ...
                              <div className="description">
                                ...
                                <h4 className="name">
                                  <a href="#" className>
                                    ...
                                    >
                                      Ly nhựa 2 lớp có ống hút Lock&amp;Lock
                                      Bucket cold cup 580ml - HAP520
                                    </span>
                                  </a>
                                </h4>
                                <ul className="xans-element- xans-product xans-product-listitem-2 xans-product-listitem xans-product-2 spec">
                              ...
                              <div className="description">
                                ...
                                <h4 className="name">
                                  <a href="#" className>
                                    ...
                                    >
                                      Giá phơi đồ gấp gọn hình chữ A cứng cáp,
                                      bằng sắt màu đen Lock&amp;Lock Drying Rack
                                    </span>
                                  </a>
                                </h4>
                                <ul className="xans-element- xans-product xans-product-listitem-2 xans-product-listitem xans-product-2 spec">
                              ...
                              <div className="description">
                                ...
                                <h4 className="name">
                                  <a href="#" className>
                                    ...
                                    >
                                      Bộ chổi kèm hốt rác đa năng Sweepy - Màu
                                      xanh - ETM976
                                    </span>
                                  </a>
                                </h4>
                              ...
                              <div className="description">
                                ...
                                <h4 className="name">
                                  <a href="#" className>
                                    ...
                                    >
                                      Cây lau sàn phẳng , gạt nước sàn nhà ,
                                      chổi gạt kính đa năng Sweepy - ETM975
                                    </span>
                                  </a>
                                </h4>
                                <ul className="xans-element- xans-product xans-product-listitem-2 xans-product-listitem xans-product-2 spec">
                              ...
                              <div className="thumbnail">
                                <div className="prdImg">
                                  <div className="wrap-thumbnail">
                                    <a className="BG-thumbnail" href="#">
                                      <img
                                        src="assets/imgs/a88f3b025ada5726aee6395bd6fe02d2.jpg"
                                ...
                                <h4 className="name">
                                  <a href="#" className>
                                    ...
                                    >
                                      ...
                                      nước bẩn SWEEPY ETM972 - 2.5L - Cây lau
                                      tròn bản rộng - Xoay 360 độ
                                    </span>
                                  </a>
                                </h4>
                                <ul className="xans-element- xans-product xans-product-listitem-2 xans-product-listitem xans-product-2 spec">
                                ...
                                <div className="prdImg">
                                  <div className="wrap-thumbnail">
                                    <a className="BG-thumbnail" href="#">
                                      <img
                                        src="assets/imgs/2a6306c708febd507c98cbde702280be.jpg"
                                        id="eListPrdImage716_3"
                                        alt="Bộ cây lau nhà Sweepy ETM970 gồm thùng giặt, cây lau và 2 bông lau - 5.5L - Màu xanh"
                                      />
                                    </a>
                                  </div>
                                  <div className="salebox displaynone">
                              ...
                              <div className="description">
                                ...
                                <h4 className="name">
                                  <a href="#" className>
                                    ...
                                    >
                                      Bộ cây lau nhà Sweepy ETM970 gồm thùng
                                ...
                                <div className="prdImg">
                                  <div className="wrap-thumbnail">
                                    <a className="BG-thumbnail" href="#">
                                      <img
                                        src="assets/imgs/2a6306c708febd507c98cbde702280be.jpg"
                                        id="eListPrdImage710_3"
                                        alt="Máy xay sinh tố Locknlock Multi Blender 220-240V, 50/60Hz, 800W, 1.5L - EJM416WHT"
                                      />
                                    </a>
                                  </div>
                                  <div className="salebox displaynone">
                              ...
                              <div className="description">
                                ...
                                <h4 className="name">
                                  <a href="#" className>
                                    ...
                                    >
                                      Máy xay sinh tố Locknlock Multi Blender
                                      220-240V, 50/60Hz, 800W, 1.5L - EJM416WHT
                                    </span>
                                  </a>
                                </h4>
                                <ul className="xans-element- xans-product xans-product-listitem-2 xans-product-listitem xans-product-2 spec">
                                ...
                                <div className="prdImg">
                                  <div className="wrap-thumbnail">
                                    <a className="BG-thumbnail" href="#">
                                      <img
                                        src="assets/imgs/2a6306c708febd507c98cbde702280be.jpg"
                                        id="eListPrdImage704_3"
                                        alt="Ly nhựa 2 lớp Lock&amp;Lock kèm ống hút Dream star Double wall cold cup 750ml - HAP522"
                                      />
                                    </a>
                                  </div>
                                  <div className="salebox displaynone">
                              ...
                              <div className="description">
                                ...
                                <h4 className="name">
                                  <a href="#" className>
                                    ...
                                    >
                                      Ly nhựa 2 lớp Lock&amp;Lock kèm ống hút
                                      Dream star Double wall cold cup 750ml -
                                      HAP522
                                    </span>
                                  </a>
                                </h4>
                              ...
                              <div className="thumbnail">
                                <div className="prdImg">
                                  <div className="wrap-thumbnail">
                                    <a className="BG-thumbnail" href="#">
                                      <img
                                        src="assets/imgs/84040b6cce3c20487ecacc76804b86b1.jpg"
                                        id="eListPrdImage703_3"
                                        alt="Cốc giữ nhiệt Lock&amp;Lock Metro Table Mug 600ml - LHC4282"
                                      />
                                    </a>
                                  </div>
                                  <div className="salebox displaynone">
                              ...
                              <div className="description">
                                ...
                                <h4 className="name">
                                  <a href="#" className>
                                    ...
                                    >
                                      Cốc giữ nhiệt Lock&amp;Lock Metro Table
                                      Mug 600ml - LHC4282
                                    </span>
                                  </a>
                                </h4>
                      ...
                      <div className="swiper-pagination3 swiper-pagination-clickable swiper-pagination-bullets swiper-pagination-horizontal">
              ...
              <div className="in-article">
                <div className="root_width">
                  <div className="productList mProduct typeThumb">
                    <div className="wrap-banner">
                      <a href="#">
                        <img src="assets/imgs/ricecooker%20pc%20copy.jpg" />
                      </a>
                    </div>
                    <div className="in-article root_width Product-list-slide">
                      <div className="xans-element- xans-product xans-product-listmain-2 xans-product-listmain xans-product-2 mProduct swiper-container swiper-container3 swiper-initialized swiper-horizontal swiper-pointer-events">
                              ...
                              <div className="thumbnail">
                                <div className="prdImg">
                                  <div className="wrap-thumbnail">
                                    <a className="BG-thumbnail" href="#">
                                      <img
                                        src="assets/imgs/b045d6494eaec76a0b33e961a8a0b360.jpg"
                                        id="eListPrdImage726_3"
                                        alt="Bộ chổi kèm hốt rác đa năng Sweepy - Màu xanh - ETM976"
                                      />
                                    </a>
                ...
                <div className="root_width">
                  <div className="xans-element- xans-product xans-product-listmain-27 xans-product-listmain xans-product-27 productList mProduct typeThumb">
                    ...
                    <ul className="prdList prdList_num">
                            ...
                            <h4 className="name">
                              <a href="#" className>
                                <span
                                  style={{ fontSize: "12px", color: "#555555" }}
                                >
                                  Bộ hộp cơm giữ nhiệt Lock&amp;Lock Pump Vacuum
                                  Lunch Box (300ml*2, 500ml*1, bộ đũa và thìa,
                                  túi) - LHC8052S01
                                </span>
                              </a>
                            </h4>
                            ...
                            <h4 className="name">
                              <a href="#" className>
                                <span
                                  style={{ fontSize: "12px", color: "#555555" }}
                                >
                                  Bình giữ nhiệt Lock&amp;Lock Jumbo Tumbler 900
                                  ml - LHC4300
                                </span>
                              </a>
                            </h4>
                            ...
                            <div className="prdImg">
                              <div className="wrap-thumbnail">
                                <a className="BG-thumbnail" href="#">
                                  <img
                                    src="assets/imgs/2a6306c708febd507c98cbde702280be.jpg"
                                    id="eListPrdImage673_28"
                                    alt="Máy tăm nước không dây Lock&amp;Lock Jumbo cordless oral irrigator 280ml - ENR126WHT"
                                  />
                                </a>
                              </div>
                              <div className="salebox yet_slaebox displaynone">
                            ...
                            <h4 className="name">
                              <a href="#" className>
                                <span
                                  style={{ fontSize: "12px", color: "#555555" }}
                                >
                                  Máy tăm nước không dây Lock&amp;Lock Jumbo
                                  cordless oral irrigator 280ml - ENR126WHT
                                </span>
                              </a>
                            </h4>
                            <ul className="xans-element- xans-product xans-product-listitem-27 xans-product-listitem xans-product-27 spec">
                            ...
                            <div className="prdImg">
                              <div className="wrap-thumbnail">
                                <a className="BG-thumbnail" href="#">
                                  <img
                                    src="assets/imgs/2a6306c708febd507c98cbde702280be.jpg"
                                    id="eListPrdImage413_28"
                                    alt="ENR111BLU - Máy tăm nước Lock&amp;lock, Oral Irrigator, DC12V, 18W, 600ml, Màu xanh dương"
                                  />
                                </a>
                              </div>
                              <div className="salebox yet_slaebox displaynone">
                            ...
                            <h4 className="name">
                              <a href="#" className>
                                <span
                                  style={{ fontSize: "12px", color: "#555555" }}
                                >
                                  ENR111BLU - Máy tăm nước Lock&amp;lock, Oral
                                  Irrigator, DC12V, 18W, 600ml, Màu xanh dương
                                </span>
                              </a>
                            </h4>
                            <ul className="xans-element- xans-product xans-product-listitem-27 xans-product-listitem xans-product-27 spec">
                      ...
                      <li id="anchorBoxId_580" className="xans-record-">
                        <div className="inner">
                          <div className="thumbnail">
                            <div className="prdImg">
                              <div className="wrap-thumbnail">
                      ...
                      <li id="anchorBoxId_578" className="xans-record-">
                        <div className="inner">
                          <div className="thumbnail">
                            <div className="prdImg">
                              <div className="wrap-thumbnail">
                                <a className="BG-thumbnail" href="#">
                                  <img
                                    src="assets/imgs/2a6306c708febd507c98cbde702280be.jpg"
                                    id="eListPrdImage578_28"
                                    alt="CSU1225PIK - Chảo sâu lòng Suit LocknLock, 22CM - Màu Pink"
                                  />
                                </a>
                              </div>
                              <div className="salebox yet_slaebox displaynone">
                            ...
                            <h4 className="name">
                              <a href="#" className>
                                <span
                                  style={{ fontSize: "12px", color: "#555555" }}
                                >
                                  CSU1225PIK - Chảo sâu lòng Suit LocknLock,
                                  22CM - Màu Pink
                                </span>
                              </a>
                            </h4>
                            ...
                            <h4 className="name">
                              <a href="#" className>
                                ...
                                >
                                  ...
                                  Nghiền đá/ Xay sinh tố) - EJM476SLV
                                </span>
                              </a>
                            </h4>
                            <ul className="xans-element- xans-product xans-product-listitem-21 xans-product-listitem xans-product-21 spec">
                            ...
                            <h4 className="name">
                              <a href="#" className>
                                <span
                                  style={{ fontSize: "12px", color: "#555555" }}
                                >
                                  Bàn chải đánh răng điện LockLock cho bé từ 3
                                  tuổi - chống nước - pin sử dụng lên tới 3 tuần
                                  - ENR226WHT
                                </span>
                              </a>
                            </h4>
                            ...
                            <div className="prdImg">
                              <div className="wrap-thumbnail">
                                <a className="BG-thumbnail" href="#">
                                  <img
                                    src="assets/imgs/2a6306c708febd507c98cbde702280be.jpg"
                                    id="eListPrdImage676_22"
                                    alt="Bàn chải điện Smart oscillating electric toothbrush Lock&amp;lock - ENR626BLK"
                                  />
                                </a>
                              </div>
                              <div className="salebox yet_slaebox displaynone">
                            ...
                            <h4 className="name">
                              <a href="#" className>
                                <span
                                  style={{ fontSize: "12px", color: "#555555" }}
                                >
                                  Bàn chải điện Smart oscillating electric
                                  toothbrush Lock&amp;lock - ENR626BLK
                                </span>
                              </a>
                            </h4>
                            <ul className="xans-element- xans-product xans-product-listitem-21 xans-product-listitem xans-product-21 spec">
                            ...
                            <div className="prdImg">
                              <div className="wrap-thumbnail">
                                <a className="BG-thumbnail" href="#">
                                  <img
                                    src="assets/imgs/2a6306c708febd507c98cbde702280be.jpg"
                                    id="eListPrdImage675_22"
                                    alt="Nồi chiên không dầu LocknLock Visible air fryer CUBE 5.5L, 220-240V, 50/60Hz, 1800W - EJF996BLK"
                                  />
                                </a>
                              </div>
                              <div className="salebox yet_slaebox displaynone">
                            ...
                            <h4 className="name">
                              <a href="#" className>
                                <span
                                  style={{ fontSize: "12px", color: "#555555" }}
                                >
                                  Nồi chiên không dầu LocknLock Visible air
                            ...
                            <div className="prdImg">
                              <div className="wrap-thumbnail">
                                <a className="BG-thumbnail" href="#">
                                  <img
                                    src="assets/imgs/2a6306c708febd507c98cbde702280be.jpg"
                                    id="eListPrdImage670_22"
                                    alt="Bình giữ nhiệt Lock&amp;Lock DIY Strap Tumbler 350ml - LHC3283"
                                  />
                                </a>
                              </div>
                              <div className="salebox yet_slaebox displaynone">
                            ...
                            <h4 className="name">
                              <a href="#" className>
                                <span
                                  style={{ fontSize: "12px", color: "#555555" }}
                                >
                                  Bình giữ nhiệt Lock&amp;Lock DIY Strap Tumbler
                                  350ml - LHC3283
                                </span>
                              </a>
                            </h4>
                            ...
                            <div className="prdImg">
                              <div className="wrap-thumbnail">
                                <a className="BG-thumbnail" href="#">
                                  <img
                                    src="assets/imgs/2a6306c708febd507c98cbde702280be.jpg"
                                    id="eListPrdImage393_22"
                                    alt="Máy Vắt Cam Lock&amp;Lock EJJ231 (700ml)"
                                  />
                                </a>
                              </div>
                              <div className="salebox yet_slaebox displaynone">
