            ...
            <div className="root_width">
              ...
              <div className="path">
                ...
                <ol>
                  ...
                  <li title="Current Page"><strong>Hệ thống cửa hàng</strong></li>
                </ol>
              </div>
              <div className="customer_sidenav">
                ...
                <a href="/stores.html" className="on">Hệ thống cửa hàng</a>
                <a href="/policys.html">Chính sách &amp; Quy định chung</a>
                <a href="/warranty_policy.html">Chính sách bảo hành</a>
                <div className="customer_top">
                  <img src="assets/imgs/tel_icon.png" alt="" /><span className="customer_bold">028-5413 5750 (487)</span>
                ...
                <div className="store_width">
                  <div className="store_img">
                    <div className="text-store">
                      ...
                      <span>Hãy tìm cửa hàng<br />
                        Lock&amp;Lock gần nhất với bạn.</span>
                    </div>
                  </div>
                  <div className="store_width_tab">
                        ...
                        <table className="store_table">
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td className="store_tablecenter">0024 3974 8327</td>
                      ...
                      <div>
                        <table className="store_table">
                          <tbody>
                            ...
                            <tr>
                              <td><a href="/stores/mega.html">F2C Huế</a></td>
                              <td>
                    ...
                    <div id="mien_nam" className="store_tabcontent" style={{display: 'block'}}>
                      <div>
                        <table className="store_table">
                          <tbody>
                            <tr>
