            ...
            <div className="root_width">
              <div className="path">
                ...
                <ol>
                  ...
                  <li title="Current Page"><strong>Hồ Sơ Của Tôi</strong></li>
                </ol>
              </div>
              <div className="clearBoth">
                ...
                <div className="myshpp-right">
                    ...
                    <div className="ec-base-box typeMember gMessage displaynone">
                      <div className="information">
                        <p className="thumbnail">
                          <img src className="myshop_benefit_group_image_tag" alt=''/>
                        </p>
                        <div className="description">
                          <p>
                            Cám ơn bạn đã mua sắm cùng chúng tôi.
                            <strong className="txtEm"><span className="authssl_member_name">*****</span></strong>hạng thành viên của bạn là
                            <strong>[<span className="xans-member-var-group_name" /><span className="myshop_benefit_ship_free_message" />]</strong>.
                          </p>
                          <p className="displaynone myshop_benefit_display_no_benefit">
                            Nhận <span className="myshop_benefit_use_dc" /> của
                            <strong className="txtEm"><span className="myshop_benefit_dc_price" /><span className="myshop_benefit_dc_type" /></strong>
                            khi bạn mua hàng
                            <strong className="txtEm"><span className="myshop_benefit_dc_pay" />
                              <span className="myshop_benefit_dc_min_price" /></strong>. <span className="myshop_benefit_dc_max_percent" />
                          </p>
                          <p className="displaynone myshop_benefit_display_with_all">
                            Nhận
                            <span className="myshop_benefit_use_dc_mileage" />
                            của
                            <strong className="txtEm"><span className="myshop_benefit_dc_price_mileage" /><span className="myshop_benefit_dc_type_mileage" /></strong>
                            khi bạn mua hàng
                            <strong className="txtEm"><span className="myshop_benefit_dc_pay" />
                              <span className="myshop_benefit_dc_min_price_mileage" /></strong>.
                  ...
                  <form id="editForm" name="editForm" method="post">
                    ...
                    <input id="sEData" name="sEData" defaultValue="" type="hidden" />
                    <input id="sEDataDiff" name="sEDataDiff" defaultValue="" type="hidden" />
                    ...
                    <div className="xans-element- xans-member xans-member-edit">
                          ...
                          <tbody>
                            <tr className="displaynone">
                              ...
                              <td>
                                ...
                                <span id="idMsg" />
                                <a href="#none" id="use_email_confirm_button" className="btnNormal displaynone">Đăng nhập bằng ID hoặc Email</a>
                              </td>
                            </tr>
                            <tr>
                              <th scope="row">
                              ...
                              <td>
                                <div className="eTooltip">
                                  <input id="passwd" name="passwd"  autoComplete="off" maxLength={16} disabled={1} defaultValue type="password" />
                            ...
                            <tr className="displaynone">
                              ...
                              <td>
                                <div className="eTooltip">
                                  <input id="new_passwd" name="new_passwd"  maxLength={16} disabled={1} defaultValue type="password" />
                                  <div className="ec-base-tooltip typeUpper">
                                    <div className="content">
                                      <strong className="txtWarn">※ Quy định đặt mật khẩu</strong>
                                      <ul className="ec-base-help typeDash gBlank10 txtWarn">
                            ...
                            <tr className="displaynone">
                              <th scope="row">Xác Nhận <br />Mật khẩu mới</th>
                              <td>
                            ...
                            <tr>
                              ...
                              <td>
                                <input id="email1" name="email1" fw-alone="N"  defaultValue type="text" />
                                <span id="emailMsg" />
                              </td>
                            </tr>
                            <tr className>
                              ...
                              <td>
                                <input id="name" name="name"  className="ec-member-name" placeholder maxLength={30} defaultValue="Lâm Ánh Nguyệt" type="text" />
                              </td>
                            </tr>
                            <tr className="displaynone">
                              <th scope="row">
                            ...
                            <tr className>
                              ...
                              <td>
                                <ul className="ec-address">
                                  <li id="fmodify_country_wrap" className="displaynone">
                                    <select id="country" name="country" className="displaynone gCheckbox60" disabled>
                                    ...
                                    <span id="fmodify_directInputCheck_wrap" className="ec-base-label displaynone">
                                  ...
                                  <li id="fmodify_baseAddr_wrap" className="displaynone">
                                    <input id="addr1" name="addr1" placeholder="Phường/Xã"  className="inputTypeText displaynone" type="text" size={60} maxLength={100} disabled />
                                  </li>
                                  <li id="fmodify_detailAddr_wrap" className="displaynone">
                                    <input id="addr2" name="addr2" placeholder="Địa chỉ chi tiết(không bắt buộc)"  className="inputTypeText displaynone" type="text" size={60} maxLength={255} disabled />
                                  </li>
                                  <li id="fmodify_state_wrap" className="displaynone">
                                    <select id="stateListUs" name="stateListUs" className="displaynone" disabled>
                                      <option value>Tiểu bang</option></select><select id="stateListCa" name="stateListCa" className="displaynone" disabled>
                                      <option value>
                                        Tỉnh bang/Vùng lãnh thổ
                                      </option></select><input id="state_name" name="state_name" placeholder="Tỉnh/Thành"  className="inputTypeText displaynone" type="text" size={30} maxLength={50} disabled />
                                  </li>
                                  <li id="fmodify_city_wrap" className="displaynone">
                                    <input id="city_name" name="city_name" placeholder="Quận/Huyện"  className="inputTypeText displaynone" type="text" size={30} maxLength={50} disabled />
                                  </li>
                                  <li id="fmodify_street_wrap" className="displaynone">
                                    <input id="street_name" name="street_name" placeholder="Phường/Xã"  className="inputTypeText displaynone" type="text" size={30} maxLength={50} disabled />
                                  </li>
                                  <li id="fmodify_area_wrap" className="ec-address-area displaynone">
                                    <select id="si_name_addr" name="si_name_addr" className="displaynone" disabled>
                                      <option value>Tỉnh/Thành</option></select><select id="ci_name_addr" name="ci_name_addr" className="displaynone" disabled>
                                      <option value>Quận/Huyện</option></select><select id="gu_name_addr" name="gu_name_addr" className="displaynone" disabled>
                                      <option value>Phường/Xã</option>
                                    </select>
                                  </li>
                                  <li id="fmodify_zipcode_wrap" className="ec-address-zipcode displaynone">
                                    <input id="postcode1" name="postcode1" placeholder="Mã bưu chính"  className="inputTypeText displaynone" type="text" maxLength={14} disabled />
                                    <button id="postBtn" className="btnBasic displaynone" type="button" disabled>
                                      ADDR.COMMON.FORMATZIPCODEBTN.VN</button><span className="ec-base-label">
                                      <input id="nozip" name="nozip" className="displaynone" type="checkbox" disabled />
                                      <label id="modify_zipcode_check_label" htmlFor="nozip" className="displaynone" disabled>Không có mã bưu chính</label> </span><span id="fmodify_zipcodeNotFoundMsg_wrap" className="ec-base-label displaynone">
                            ...
                            <tr className>
                              ...
                              <td className="phone-td">
                                <select id="phone1" name="phone[]" fw-alone="N" >
                                  ...
                                  <option value={263}>
                                    Zimbabwe(+263)
                                  </option></select>-<input id="phone2" name="phone[]" maxLength={15} fw-alone="N"  defaultValue type="text" />
                              </td>
                            </tr>
                            <tr className>
                              <th scope="row">
                              ...
                              <td className="phone-td">
                                <select id="mobile1" name="mobile[]" fw-alone="N" >
                                  ...
                                  <option value={263}>
                                    Zimbabwe(+263)
                                  </option></select>-<input id="mobile2" name="mobile[]" maxLength={15} fw-alone="N"  defaultValue type="text" />
                              </td>
                            </tr>
                            <tr className="displaynone">
                              <th scope="row">
                          ...
                          <tbody>
                            ...
                            <tr className>
                              ...
                              <td>
                                ...
                                /
                                <input id="birth_year" name="birth_year"   className="inputTypeText" placeholder maxLength={4} defaultValue type="text" /><span className="gIndent20"><input id="is_solar_calendar0" name="is_solar_calendar"   defaultValue="T" type="radio" defaultChecked="checked" /><label htmlFor="is_solar_calendar0">Dương lịch</label>
                                  <input id="is_solar_calendar1" name="is_solar_calendar"   defaultValue="F" type="radio" /><label htmlFor="is_solar_calendar1">Âm lịch</label></span>
                              </td>
                            </tr>
                            <tr className>
                              <th scope="row">
                        ...
                        <div className="ec-base-box typeThinBg agreeArea">
                          <div className="content">
                            <div className="fr-view fr-view-privacy-optional">
                              ...
                              **<br /><br />1. Mục đích thu thập và sử dụng thông
                              tin cá nhân<br />Liệt kê mục đích sử dụng các hạng
                              mục không bắt buộc được nhập khi đăng ký thành viên
                              (Ví dụ: Dùng với mục đích marketing và gợi ý nội
                              dung phù hợp với khác hàng).<br /><br />2. Hạng mục
                              thông tin cá nhân được thu thập<br />Liệt kê các
                              hạng mục không bắt buộc được nhập khi khách hàng
                              đăng ký thành viên (Ví dụ: ngày sinh, giới tính).<br /><br />3.
                              Thời hạn lưu giữ và sử dụng thông tin cá nhân<br />Thông
                              tin cá nhân sẽ được hủy ngay lập khi xóa các hạng
                              mục này bằng cách chỉnh sửa thông tin thành viên
                              hoặc đóng tài khoản.<br /><br />Khách hàng vẫn có
                              thể sử dụng dịch vụ ngay cả khi không đồng ý với các
                              điều khoản này.
                            </div>
                          </div>
                          <p className="check">
                            <span>Tôi đã đọc và đồng ý với chính sách thu thập và sử
                              dụng thông tin cá nhân.</span>
                            <input id="agree_privacy_optional_check0" name="agree_privacy_optional_check[]"   defaultValue="T" type="checkbox" /><label htmlFor="agree_privacy_optional_check0">Đồng ý</label>
                          </p>
                        </div>
                      </div>
                      <div className="displaynone">
                        ...
                        <div className="ec-base-box typeThinBg agreeArea">
                          ...
                          <p className="check">
                            <span>Bạn có đồng ý chia sẻ thông tin cá nhân với bên thứ
                              ba không?</span>
                            <input id="agree_information_check0" name="agree_information_check[]"   defaultValue={1} type="checkbox" /><label htmlFor="agree_information_check0">Đồng ý</label>
                          </p>
                        </div>
                      </div>
                      <div className="displaynone">
                        ...
                        <div className="ec-base-box typeThinBg agreeArea">
                          ...
                          <p className="check">
                            <span>Bạn có đồng ý với chính sách ủy thác thông tin cá
                              nhân của bạn?</span>
                            <input id="agree_consignment_check0" name="agree_consignment_check[]" defaultValue={1} type="checkbox" /><label htmlFor="agree_consignment_check0">Đồng ý</label>
                          </p>
                        </div>
                      </div>
                      <div className="ec-base-button justify">
                        <a href="#none" className="btnBlack">Lưu</a>
                        <a href="/index.html" className="btnWhite">Huỷ</a>
                        <span className="gRight">
                          <a href="#none" className="btnWhite">Đóng Tài Khoản</a>
                        </span>
                      </div>
                      <div id className="layerLeave ec-base-layer">
                              ...
                              <div className="description">
                                <ul>
                                  ...
                                  <li>
                                    ...
                                    <strong id className="txtEm">0</strong>
                                  </li>
                                  <li id>
                                    Số Dư Tiền Cọc :
                                    <strong id className="txtEm">0</strong>
                        ...
                        <div className="ec-base-button">
                          <a href="#none" className="btnSubmit sizeS" id>Hủy tư cách thành viên</a>
                          <a href="#none" className="btnNormalFix sizeS">Huỷ</a>
                        </div>
                        <a href="#none" className="close">
                          <img src="assets/imgs/btn_close.gif" alt="Close" /></a>
                      </div>
                    </div>
                  </form>
                </div>
