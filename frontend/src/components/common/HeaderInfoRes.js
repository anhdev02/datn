        ...
        <div className="header sub-header">
          ...
          <section id="topArea">
            <nav id="mainMenu">
              <div
                id="mainMenuIn"
                className="xans-element- xans-product xans-product-menupackage swiper-container swiper-container0 swiper-container-initialized swiper-container-horizontal swiper-container-ios"
              >
                <ul className="swiper-wrapper">
                  <li className="swiper-slide my_li1 swiper-slide-active">
                    <Link className="my_a" to="/order">
                      Đơn hàng
                    </Link>
                  </li>
                  ...
                  <li className="swiper-slide my_li7">
                    <Link className="my_a" to="/accountinfo">
                      Tài khoản
                    </Link>
                  </li>
                </ul>
