...
const BestSeller = () => {
  ...
  useEffect(() => {
    fetch("https://locknlock-dvxb.onrender.com/api/product/bestseller/36")
      .then((res) => res.json())
  ...
  const updatedProducts = productsBestSeller.map((product) => {
              ...
              <div className="xans-element- xans-product xans-product-headcategory path">
                ...
                <ol>
                  ...
                  <li title="Current Page">
                    <strong>Hàng chạy nhất</strong>
                  </li>
                </ol>
              </div>
              <div className="xans-element- xans-product xans-product-headcategory title">
                <p className="banner">
                  <img src="https://locknlock-d1171.web.app/assets/imgs/best seller_1140x282_0621.jpg" alt="" />
                </p>
                <h2>
                  <span>Hàng chạy nhất</span>
                </h2>
              </div>
            </div>
